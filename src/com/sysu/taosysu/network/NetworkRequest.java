...
public class NetworkRequest {
	...
	public static void login(String userName, String password, LoginAsyncTask.OnRequestListener listener) {
		new LoginAsyncTask(userName, password, listener).execute(SERVER_URI);
	}
	
	public static void uploadBook(int userId, String bookName, String content, String[] label, UploadBookAsyncTask.OnRequestListener listener) {
		new UploadBookAsyncTask(userId, bookName, content, label, listener).execute(SERVER_URI);
	}
